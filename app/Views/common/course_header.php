						...
						<div class="row pt-3">
							...
							<div class="col-8 menu-lg">
								<a href="<?= base_url('home'); ?>"
									class="menu-item <?= ($segment1 === 'home') ? 'active' : '' ?>">Home</a>

								<a href="<?= base_url('course'); ?>"
									class="menu-item <?= ($segment1 === 'course') ? 'active' : '' ?>">Courses</a>

								<a href="<?= base_url('leaderboard'); ?>"
									class="menu-item <?= ($segment1 === 'leaderboard') ? 'active' : '' ?>">Leaderboard</a>

								<a href="<?= base_url('community'); ?>"
									class="menu-item <?= ($segment1 === 'community') ? 'active' : '' ?>">Community</a>

								<a href="<?= base_url('helpdesk'); ?>"
									class="menu-item <?= ($segment1 === 'helpdesk') ? 'active' : '' ?>">Help Desk</a>
							</div>
							...
							<div class="col-3 text-right btn-holder d-flex align-items-center justify-content-end">
								...
								<div class="dropdown">
									<button
										...
										aria-expanded="false">
										<img src="<?php echo base_url() . ASSET_PATH; ?>user/assets/img/profile.jpeg"
